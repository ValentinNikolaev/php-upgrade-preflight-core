...
final class LockDiff
{
    ...
    /** @return array{package_changes: list<array{name: string, change_type: string, from_version: ?string, to_version: ?string, direct: bool, major_change: bool, package_families: list<string>, from_source_reference: ?string, to_source_reference: ?string, from_dist_reference: ?string, to_dist_reference: ?string}>} */
